...
- RIS and PACS were among the first IT-systems in hospitals

- RIS and PACS are widely accepted and utilized
...
- AI applications support the diagnostic decision making processes in Radiology

- AI starts to outperform human capabilites e.g. detect cancer from X-rays
]
]
...
## RIS and PACS are expected to be implemented at least in 90% of German hospitals
...
.large[
- What are Innovation and Imitation Forces ...?
